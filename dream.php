...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3"><span class="bg-secondary px-2">Your Dream List</span></h1>
            ...
            <div class="col-lg-12 table-responsive mb-5">
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody>
                        ...
                        <?php 
                        $sqldream="select * from dreamlist where userID = '".$_SESSION['userid']."'";
                        $resdream=mysqli_query($con,$sqldream);
                        while($rowdream = mysqli_fetch_array($resdream)):
                        ?>
                        <tr>
                            <td><input type="radio" class="text-center" name="select1" checked></td>
                            <?php 
                            $sqlhouse="select * from houseinfo where ID = '".$rowdream['HouseID']."'";
                            ...
                            echo $converted;?></td>
                            <td class="align-middle"><?php echo $rowhouse['Status']?></td>
                            <td class="align-middle">
                                <form action="ordermanage.php" method="POST">
                                        <input type="hidden" name="id" value="<?php echo $rowdream['ID'] ?>">
                                         <button class="btn btn-sm btn-primary" name="delcart"><i class="fa fa-times"></i></button>
                                </form>
                            </td>
                        </tr>
                        <?php endwhile ?>
